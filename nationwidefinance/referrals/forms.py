...
class CreateProfileForm(forms.ModelForm):
    ...
    def __init__(self,user=None,*args,**kwargs):
        ...
        # self.initial['notify_url'] = settings.PAYPAL_NOTIFY_URL
        # self.initial['cancel_return'] = settings.PAYPAL_CANCEL_RETURN_URL
        # self.initial['return_url'] = settings.PAYPAL_RETURN_URL

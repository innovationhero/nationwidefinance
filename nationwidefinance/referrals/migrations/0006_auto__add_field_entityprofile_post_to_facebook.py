...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EntityProfile.post_to_facebook'
        db.add_column('referrals_entityprofile', 'post_to_facebook',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EntityProfile.post_to_facebook'
        db.delete_column('referrals_entityprofile', 'post_to_facebook')

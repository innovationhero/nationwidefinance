...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'EntityProfile.post_to_twitter'
        db.add_column('referrals_entityprofile', 'post_to_twitter',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'EntityProfile.post_to_twitter'
        db.delete_column('referrals_entityprofile', 'post_to_twitter')

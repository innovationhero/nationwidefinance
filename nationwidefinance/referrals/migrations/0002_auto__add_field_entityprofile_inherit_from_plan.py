...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EntityProfile.inherit_from_plan'
        db.add_column('referrals_entityprofile', 'inherit_from_plan',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EntityProfile.inherit_from_plan'
        db.delete_column('referrals_entityprofile', 'inherit_from_plan')

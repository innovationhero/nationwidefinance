...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EntityReferral.organization'
        db.add_column('referrals_entityreferral', 'organization',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='entity_referred', to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EntityReferral.organization'
        db.delete_column('referrals_entityreferral', 'organization_id')

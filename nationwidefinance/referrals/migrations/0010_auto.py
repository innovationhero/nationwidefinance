...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing M2M table for field department on 'EntityProfile'
        db.delete_table('referrals_entityprofile_department')

        # Adding M2M table for field departments on 'EntityProfile'
        db.create_table('referrals_entityprofile_departments', (
        ...
        db.create_unique('referrals_entityprofile_departments', ['entityprofile_id', 'department_id'])


    def backwards(self, orm):
        # Adding M2M table for field department on 'EntityProfile'
        db.create_table('referrals_entityprofile_department', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('entityprofile', models.ForeignKey(orm['referrals.entityprofile'], null=False)),
            ('department', models.ForeignKey(orm['referrals.department'], null=False))
        ))
        db.create_unique('referrals_entityprofile_department', ['entityprofile_id', 'department_id'])

        # Removing M2M table for field departments on 'EntityProfile'
        db.delete_table('referrals_entityprofile_departments')
    ...
    models = {
        ...
        'referrals.entityprofile': {
            ...
            'departments': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['referrals.Department']", 'symmetrical': 'False'}),
            'direct_referal_value': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'entity_active': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EntityPlan.price'
        db.add_column('referrals_entityplan', 'price',
                      self.gf('django.db.models.fields.CharField')(default='10.0', max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EntityPlan.price'
        db.delete_column('referrals_entityplan', 'price')

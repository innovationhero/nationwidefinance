...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EntityReferral.department'
        db.alter_column('referrals_entityreferral', 'department_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['referrals.Department'], null=True))

    def backwards(self, orm):

        # Changing field 'EntityReferral.department'
        db.alter_column('referrals_entityreferral', 'department_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['referrals.Department']))

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ReferrerPoints.organization'
        db.add_column('referrals_referrerpoints', 'organization',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='points_org', to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ReferrerPoints.organization'
        db.delete_column('referrals_referrerpoints', 'organization_id')

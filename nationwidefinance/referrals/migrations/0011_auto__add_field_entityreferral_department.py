...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EntityReferral.department'
        db.add_column('referrals_entityreferral', 'department',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['referrals.Department']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EntityReferral.department'
        db.delete_column('referrals_entityreferral', 'department_id')
    ...
    models = {
        ...
        'referrals.entityreferral': {
            ...
            'created_date': ('django.db.models.fields.DateTimeField', [], {}),
            'department': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['referrals.Department']"}),
            'entity_active': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
